...
public:
	...
	static std::string buid_signature(const std::vector<Identifier>& identifier_vector, const std::vector<TypeDefinition*> signature, dim_eval_func_t evaluate_access_vector);
